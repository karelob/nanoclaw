...
1. Zkontroluj, jestli existuje `/workspace/extra/knowledge/people/{jmeno_prijmeni}.md`
...
5. Aktualizuj `/workspace/extra/knowledge/people/_index.md` — přidej osobu pokud tam není
